...
function Termsnav() {
  return (
    <div>
      <>
  {/* nav */}
  <div className="max-w-[1147px] m-auto px-[35px] tab:px-[7%] md:px-0 w-full text-center">
            ...
            <ul className="ms-auto tab:flex tab:items-center bg-white w-full tab:w-auto tab:py-0 py-4 tab:pl-0 pl-7 tab:opacity-90 opacity-0 top-[400px] transition-all ease-in duration-500">
              <li className="my-6 md:my-0">
                <Link href='/TermsAndServices'
                  className="text-xs text-black font-extrabold font-Nunito mr-6 leading-[14px]"
                >
                  Terms or service
                </Link>
              </li>
              <li className="my-6 md:my-0">
                <Link href='/Privacy'
                  className="text-xs text-black font-light font-Nunito mr-[26px] leading-[14px]"
